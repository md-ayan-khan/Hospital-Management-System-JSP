...
<title>MediFlow MS – Patients</title>
<link
...
.main {
	...
	flex: 1;
	/* topnav(52) + subnav(48) + 36px gap = 136px */
	padding-top: 136px;
	padding-left: 24px;
	padding-right: 24px;
	padding-bottom: 36px;
...
.add-form .form-row {
	display: grid;
	grid-template-columns: 2fr 1fr 0.8fr 1.4fr 2fr 1fr auto;
	gap: 12px;
	align-items: end;
}
			...
			<main class="main">
				...
				<div class="page-card">
					...
					<div class="page-card-body">
						<form action="patient" method="post" class="add-form">
							...
							<div class="form-row">
								...
								<div class="form-group">
									<label>Blood Group</label> <input type="text" name="blood"
										class="form-control" placeholder="e.g. B+" required>
								</div>
								<div class="form-group">
									<label>&nbsp;</label>
					...
					<div class="page-card-header">
						<h3>
							<i class="fa-solid fa-users"
								style="color: var(--blue); margin-right: 8px"></i> Patient
							Records
						</h3>
						<a href="patient" class="btn btn-outline btn-sm"> <i
					...
					<div class="page-card-body">
						...
						<div class="search-toolbar">
							<div class="search-box">
								<i class="fa-solid fa-magnifying-glass"></i> <input type="text"
									id="patientSearch" placeholder="Search by patient name..."
						...
						<div style="overflow-x: auto;">
							<table class="data-table" id="patientTable">
								...
								<tbody id="patientBody">
									<%
									List<patients> list = (List<patients>) request.getAttribute("patients");
									if (list != null) {
										for (patients p : list) {
									...
									<tr>
										...
										<td><%=p.getName()%></td>
										<td><span class="badge <%=badgeClass%>"><%=p.getGender()%></span></td>
										<td><%=p.getAge()%></td>
										<td><i class="fa-solid fa-phone"
											style="color: var(--muted); font-size: 11px; margin-right: 4px"></i>
											<%=p.getPhone()%></td>
										<td><%=p.getAddress()%></td>
										<td><span style="font-weight: 700; color: #c0392b;"><%=p.getBlood_group()%></span></td>
										<td style="white-space: nowrap;"><a
											href="patient?action=edit&id=<%=p.getId()%>"
											class="btn btn-warning btn-sm"> <i
												class="fa-solid fa-pen"></i> Edit
										</a> <a href="patient?action=delete&id=<%=p.getId()%>"
...
function filterPatients() {
	...
	if (query === '') {
		countEl.textContent = total + ' patient' + (total !== 1 ? 's' : '') + ' total';
		noResults.style.display = 'none';
	} else {
		countEl.textContent = visible + ' of ' + total + ' patient' + (total !== 1 ? 's' : '') + ' found';
