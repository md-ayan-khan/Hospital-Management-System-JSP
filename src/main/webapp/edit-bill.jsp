...
<%
bills b = (bills) request.getAttribute("bill");
%>
...
<title>MediFlow MS – Edit Bill</title>
<link
				...
				<div class="page-card">
					...
					<div class="page-card-body">
						...
						<div class="bill-info-bar">
							<i class="fa-solid fa-circle-info"></i> Editing Bill ID: <strong
								style="margin-left: 4px;">#<%=b.getBill_id()%></strong>
							&nbsp;|&nbsp; Patient ID: <strong>#<%=b.getPatient_id()%></strong>
							&nbsp;|&nbsp; Current Status: <strong style="margin-left: 4px;"><%=b.getPayment_status()%></strong>
						</div>

						<form action="bill" method="post">
							<input type="hidden" name="action" value="update"> <input
								type="hidden" name="bill_id" value="<%=b.getBill_id()%>">

							<div class="form-grid">

								<div class="form-group">
									<label><i class="fa-solid fa-user"
										style="margin-right: 5px"></i>Patient ID</label> <input type="number"
										name="patient_id" class="form-control"
										value="<%=b.getPatient_id()%>" required>
								</div>

								<div class="form-group">
									<label><i class="fa-solid fa-calendar-check"
										style="margin-right: 5px"></i>Appointment ID</label> <input
										type="number" name="appointment_id" class="form-control"
										value="<%=b.getAppointment_id()%>" required>
								</div>

								<div class="form-group">
									<label><i class="fa-solid fa-indian-rupee-sign"
										style="margin-right: 5px"></i>Total Amount (₹)</label> <input
										type="number" step="0.01" name="total_amount"
										class="form-control" value="<%=b.getTotal_amount()%>" required>
								</div>

								<div class="form-group">
									<label><i class="fa-solid fa-circle-check"
										style="margin-right: 5px"></i>Payment Status</label> <select
										name="payment_status" class="form-control">
										<option value="Pending"
											<%="Pending".equalsIgnoreCase(b.getPayment_status()) ? "selected" : ""%>>Pending</option>
										<option value="Paid"
											<%="Paid".equalsIgnoreCase(b.getPayment_status()) ? "selected" : ""%>>Paid</option>
										<option value="Unpaid"
											<%="Unpaid".equalsIgnoreCase(b.getPayment_status()) ? "selected" : ""%>>Unpaid</option>
									</select>
								</div>

								<div class="form-group full-width">
									<label><i class="fa-regular fa-calendar"
										style="margin-right: 5px"></i>Bill Date</label> <input type="date"
										name="bill_date" class="form-control"
										value="<%=b.getBill_date()%>" required>
								</div>
								...
								<div class="form-group full-width">
									<div class="btn-group">
										...
										<a href="bill" class="btn btn-secondary"> <i
