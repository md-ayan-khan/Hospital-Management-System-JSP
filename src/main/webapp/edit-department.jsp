...
<title>MediFlow MS – Edit Department</title>
<link
				...
				<div class="page-card">
					...
					<div class="page-card-body">
						...
						<div class="dept-info-bar">
							<i class="fa-solid fa-circle-info"></i> Editing: <strong
								style="margin-left: 4px;"><%=d.getDepartment_name()%></strong>
							&nbsp;|&nbsp; ID: <strong>#<%=d.getDepartment_id()%></strong>
						</div>
							...
							<div class="form-grid">
								...
								<div class="form-group full-width">
									<label><i class="fa-solid fa-building"
										style="margin-right: 5px"></i>Department Name</label> <input
								...
								<div class="form-group full-width">
									<label><i class="fa-solid fa-location-dot"
										style="margin-right: 5px"></i>Location / Floor</label> <input
								...
								<div class="form-group full-width">
									<div class="btn-group">
										...
										<a href="department" class="btn btn-secondary"> <i
