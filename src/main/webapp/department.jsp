...
<title>MediFlow MS – Departments</title>
<link
...
<body>
		...
		<div class="topnav-right">
			<div class="topnav-search">
				<i class="fa-solid fa-magnifying-glass"></i> <input type="text"
					placeholder="Search departments, locations...">
			</div>
	...
	<!-- SUBNAV -->
	<div class="subnav">
		<span class="subnav-title">Departments</span> <span class="breadcrumb">
			...
			<aside class="sidebar" id="sidebar">
				<div class="menu">
					<a href="index.jsp"><i class="fa-solid fa-table-columns"></i>
						...
						href="bill"><i class="fa-solid fa-money-bill"></i> Billing</a> <a
						class="active" href="department"><i
			...
			<main class="main">
				...
				<div class="page-card">
					...
					<div class="page-card-body">
						<form action="department" method="post" class="add-form">
							...
							<div class="form-row">
								...
								<div class="form-group">
									<label>Location / Floor</label> <input type="text"
										name="location" class="form-control"
										placeholder="e.g. Block A, 2nd Floor" required>
								</div>
								<div class="form-group">
									<label>&nbsp;</label>
					...
					<div class="page-card-header">
						<h3>
							<i class="fa-solid fa-hospital"
								style="color: var(--blue); margin-right: 8px"></i>Department
							Records
						</h3>
						<a href="department" class="btn btn-outline btn-sm"> <i
					...
					<div class="page-card-body">
						...
						<div class="search-toolbar">
							<div class="search-box">
								<i class="fa-solid fa-magnifying-glass"></i> <input type="text"
									id="deptSearch" placeholder="Search by name or location..."
						...
						<div style="overflow-x: auto;">
							<table class="data-table" id="deptTable">
								...
								<tbody id="deptBody">
									<%
									List<departments> list = (List<departments>) request.getAttribute("departments");
									if (list != null) {
										for (departments d : list) {
									%>
									<tr>
										<td><strong>#<%=d.getDepartment_id()%></strong></td>
										<td><span class="dept-icon"><i
												class="fa-solid fa-building"></i></span> <strong><%=d.getDepartment_name()%></strong>
										</td>
										<td><i class="fa-solid fa-location-dot"
											style="color: var(--muted); font-size: 11px; margin-right: 5px"></i>
											<%=d.getLocation()%></td>
										<td style="white-space: nowrap;"><a
											href="department?action=edit&id=<%=d.getDepartment_id()%>"
											class="btn btn-warning btn-sm"> <i
												class="fa-solid fa-pen"></i> Edit
										</a> <a
											href="department?action=delete&id=<%=d.getDepartment_id()%>"
...
function filterDepartments() {
	...
	if (query === '') {
		countEl.textContent = total + ' department' + (total !== 1 ? 's' : '') + ' total';
		noResults.style.display = 'none';
	} else {
		countEl.textContent = visible + ' of ' + total + ' department' + (total !== 1 ? 's' : '') + ' found';
