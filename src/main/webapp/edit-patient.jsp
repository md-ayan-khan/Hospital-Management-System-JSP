...
<title>MediFlow MS – Edit Patient</title>
<link
...
<body>
	...
	<!-- SUBNAV -->
	<div class="subnav">
		<span class="subnav-title">Patients</span> <span class="breadcrumb">
			...
			<aside class="sidebar" id="sidebar">
				<div class="menu">
					<a href="index.jsp"><i class="fa-solid fa-table-columns"></i>
						Dashboard</a> <a class="active" href="patient"><i
					...
					<div class="page-card-body">
						...
						<div class="patient-info-bar">
							<i class="fa-solid fa-circle-info"></i> Editing record for: <strong
								style="margin-left: 4px;"><%=p.getName()%></strong>
							&nbsp;|&nbsp; ID: <strong>#<%=p.getId()%></strong>
						</div>
							...
							<div class="form-grid">
								...
								<div class="form-group">
									<label><i class="fa-solid fa-user"
										style="margin-right: 5px"></i>Patient Name</label> <input type="text"
										name="name" class="form-control" value="<%=p.getName()%>"
										required>
								</div>

								<div class="form-group">
									<label><i class="fa-solid fa-venus-mars"
										style="margin-right: 5px"></i>Gender</label> <select name="gender"
										class="form-control">
										<option value="Male"
											<%=p.getGender().equals("Male") ? "selected" : ""%>>Male</option>
										<option value="Female"
											<%=p.getGender().equals("Female") ? "selected" : ""%>>Female</option>
										<option value="Other"
											<%=p.getGender().equals("Other") ? "selected" : ""%>>Other</option>
									</select>
								</div>

								<div class="form-group">
									<label><i class="fa-solid fa-cake-candles"
										style="margin-right: 5px"></i>Age</label> <input type="number"
										name="age" class="form-control" value="<%=p.getAge()%>"
										required>
								</div>
								...
								<div class="form-group">
									<label><i class="fa-solid fa-phone"
										...
										name="phone" class="form-control" value="<%=p.getPhone()%>"
										required>
								</div>

								<div class="form-group">
									<label><i class="fa-solid fa-droplet"
										style="margin-right: 5px"></i>Blood Group</label> <input type="text"
										name="blood" class="form-control"
										value="<%=p.getBlood_group()%>" required>
								</div>

								<div class="form-group full-width">
									<label><i class="fa-solid fa-location-dot"
										style="margin-right: 5px"></i>Address</label> <input type="text"
										name="address" class="form-control"
										value="<%=p.getAddress()%>" required>
								</div>
								...
								<div class="form-group full-width">
									<div class="btn-group">
										...
										<a href="patient" class="btn btn-secondary"> <i
